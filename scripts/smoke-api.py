...
def main():
    ...
    try:
        ...
        call("PATCH", f"/hr/employees/{hr['id']}", {"username": member_name, "display_name": "冒烟员工已修改", "department": active_department["name"], "role": "user", "position": active_job_role["name"], "is_active": False, "email": "hr-smoke@example.com", "mobile": "13900000000", "office_phone": "021-12340000", "joined_at": str(date.today()), "left_at": None, "data": {"account_type": "员工账号", "staff_role": "授薪律师"}}, expected=(409,))
