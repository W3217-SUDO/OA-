...
export type ContractPaymentCandidate = { contract_object_id:number | null; case_fee_id?:number | null; case_record_id:number; case_no:string; case_title:string; case_type?:string; inform_date?:string; fee_type:string; contract_amount:number; reserved_amount:number; remaining_amount:number; remark:string };
