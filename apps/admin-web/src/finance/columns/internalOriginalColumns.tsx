...
export function createInternalOriginalColumns(context: {
    ...
    return [
        ...
        { title: "请款单号", ...moneyColumnStyle("请款单号"), dataIndex: "serial_no", width: 165 },
        {
        ...
        {
            title: "审核日期", ...moneyColumnStyle("审核日期"),
            width: 110,
        ...
        { title: "案件名称", ...moneyColumnStyle("案件名称"), dataIndex: "title", width: 190 },
        {
