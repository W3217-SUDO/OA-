...
export function createPaymentOriginalColumns(context: {
    ...
    return [
        ...
        { title: "请款单号", ...moneyColumnStyle("请款单号"), dataIndex: "serial_no", width: 165, render: (value: string, row: Fee) => wrap(row, <Button type="link" onClick={() => void context.openPaymentDetail?.(row)}>{value}</Button>) },
        {
        ...
        {
            title: "客户管理人", ...moneyColumnStyle("客户管理人"),
            width: 100,
        ...
        {
            title: "交款人", ...moneyColumnStyle("交款人"),
            width: 90,
