...
export function createTransactionColumns(context: {
    ...
    return [
        { title: "日期", ...moneyColumnStyle("日期"), dataIndex: "transaction_date", width: 105 },
        {
        ...
        {
            title: "关联费用", ...moneyColumnStyle("关联费用"),
            dataIndex: "finance_no",
            width: 175,
            render: (v: string) => v || "独立流水",
        },
        { title: "费用名称", ...moneyColumnStyle("费用名称"), dataIndex: "finance_title", width: 230 },
        { title: "凭证/票号", ...moneyColumnStyle("凭证/票号"), dataIndex: "voucher_no", width: 150 },
        {
        ...
        { title: "对方单位", ...moneyColumnStyle("对方单位"), dataIndex: "counterparty", width: 190 },
        { title: "登记人", ...moneyColumnStyle("登记人"), dataIndex: "operator", width: 90, render: (value: string, row: Transaction) => context.financePersonDisplayName(value, (row as any).operator_display_name) },
