...
export function createFeeQueryOriginalColumns(context: {
    ...
    return [
        { title: "操作", ...moneyColumnStyle("操作"), key: "action", width: 145, render: context.originalOperation },
        ...
        { title: "费用名称", ...moneyColumnStyle("费用名称"), dataIndex: "title", width: 190 },
        {
        ...
        {
            title: "付款金额", ...moneyColumnStyle("付款金额"),
            width: 110,
        ...
        {
            title: "案件阶段", ...moneyColumnStyle("案件阶段"),
            width: 105,
            render: (_: unknown, row: Fee) => row.data.case_stage || "—",
        },
        {
            title: "合同编号", ...moneyColumnStyle("合同编号"),
            width: 145,
        ...
        { title: "客户名称", ...moneyColumnStyle("客户名称"), dataIndex: "customer", width: 180, render: (value: string, row: Fee) => value ? <Button type="link" onClick={() => context.openCustomerDetail(value, row.data.customer_no)}>{value}</Button> : "—" },
        {
            title: "申请人", ...moneyColumnStyle("申请人"),
            width: 90,
        ...
        {
            title: "经办人", ...moneyColumnStyle("经办人"),
            width: 90,
