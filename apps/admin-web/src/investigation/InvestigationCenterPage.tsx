...
// Import modularized types, constants and components
import type {
  Row,
  Attachment,
  ClueEvidenceRow,
...
import EvidenceCreateModal from "./EvidenceCreateModal";
import NotaryReviewModal from "./NotaryReviewModal";
import CertificateRegisterModal from "./CertificateRegisterModal";
import ImportModal from "./ImportModal";
import SubtaskActionModal from "./SubtaskActionModal";
import InvestigationCreateModal from "./InvestigationCreateModal";
  ...
  return (
    <>
      <SubtaskActionModal
        ...
        subtaskActionTarget={subtaskActionTarget}
        subtaskActionForm={subtaskActionForm}
      ...
      <ClueCreateDrawer
        ...
        systemPersonOptions={systemPersonOptions}
        clueFiles={clueFiles}
        onClueFilesChange={(files) => setClueFiles(files)}
        onSave={() => void create(false)}
      ...
      <TurnOnAuditModal
        ...
        turnOnAuditTarget={turnOnAuditTarget}
        turnOnAuditForm={turnOnAuditForm}
        reviewerCandidatesLoading={reviewerCandidatesLoading}
      ...
      <CollectionModal
        ...
        onFilesChange={(files) => setCollectionFiles(files)}
      />
      <EvidenceCreateModal
      ...
      <CertificateRegisterModal
        ...
        certificateWarehouseId={certificateWarehouseId}
      ...
      <BatchCaseConversion
        ...
        resolvedClueContracts={resolvedClueContracts}
        ...
        onBindContract={() => void bindMissingSourceContract()}
      />
      <MaterialModal
        open={materialOpen}
        ...
        onFilesChange={(files) => setMaterialFiles(files)}
      />
      <TaskDetailDrawer
      ...
      <EvidenceEditorModal
        ...
        notaryOfficeOptions={notaryOfficeOptions}
        evidenceEditForm={evidenceEditForm}
