...
from app.models_shared import (
    ...
    FinanceTransactionInput, FinanceWriteoffInput, HearingInput, HrEmployeeBatchDeleteInput, HrEmployeeContractApprovalStatusInput, HrEmployeeSealApprovalStatusInput,
    ...
    SystemMenuInput, SystemMenuUpdate, SystemMenuVisibilityBatchInput, SystemParameterInput, SystemParameterRelationReplaceInput, SystemParameterUpdate,
...
include_route_slice(app, system_router, 77, 91)
include_route_slice(app, ipr_router, 121, 122)
include_route_slice(app, legal_router, 138, 141)
include_route_slice(app, legal_router, 141, 143)
include_route_slice(app, contract_router, 39, 45)
include_route_slice(app, finance_router, 140, 142)
include_route_slice(app, finance_router, 142, len(finance_router.routes))
include_route_slice(app, legal_router, 143, len(legal_router.routes))
include_route_slice(app, investigation_router, 41, len(investigation_router.routes))
