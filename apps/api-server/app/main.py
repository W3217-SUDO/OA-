...
from app.routing import verify_route_coverage
...
# Route registration order is not significant: no two routes in the table can
# match the same concrete path (see route_dispatch_fingerprint.py). Register each
# area router once, in full, instead of slicing it into order-preserving fragments.
