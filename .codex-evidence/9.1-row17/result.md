...
- 页面证据：`local-new-system-expired-blocked.png`、`local-new-system-future-saved.png`；进程证据为 `row17-api.out.log`、`row17-api.err.log`，原问题锚定截图为 `C_image23.png`。补验截图使用独立 Web 15490、API 18490、SQLite 和 `RQA-` 前缀夹具，由本行责任会话亲自操作 Google Chrome 生成并落盘。
